        ...
        <?php foreach ($blogPosts as $post) : ?>
            <div class="blog-post mb-5 border border-3 p-3 rounded w-75">
                <div class="d-flex justify-content-between w-100 align-items-center">
                    ...
                    <div>Posted by <span class="fst-italic text-success text-decoration-underline"><?php echo $post->user ?> </span>on <?php echo $post->date ?></div>
                </div>
                ...
                <div class="blog-tags">
                    <?php foreach ($post->tags as $tag) : ?>
                        <span class="tag rounded-pill bg-success p-1 ps-2 pe-2 text-white"><?php echo $tag; ?></span>
                    <?php endforeach ?>
                </div>
                <br />
            </div>
